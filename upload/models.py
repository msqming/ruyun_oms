...
class Erp_Stock(models.Model):
    """ERP库存数据"""
    b_c_sku = models.CharField(max_length=256,verbose_name='商品编码')
    b_c_name = models.CharField(max_length=512,verbose_name='商品名称')
    d_c_bom_type = models.CharField(max_length=64,verbose_name='性质')
    b_c_brand = models.CharField(max_length=64,verbose_name='品牌')
    category_name = models.CharField(max_length=64,verbose_name='类别')
    c_series = models.CharField(max_length=64,verbose_name='系列')
    n_finance = models.IntegerField(verbose_name='总数量')
    n_able = models.IntegerField(verbose_name='可销数')
    n_purchase = models.IntegerField(verbose_name='待入')
    n_sale = models.IntegerField(verbose_name='待出')
    n_sale_net = models.IntegerField(verbose_name='待审')
    n_production = models.IntegerField(verbose_name='生产在途')
    d_cost = models.FloatField(verbose_name='单价成本')
    kc_d_amount = models.FloatField(verbose_name='金额')
    d_cost_estimate_tax = models.FloatField(verbose_name='含税预计')
    d_cost_estimate_untax = models.FloatField(verbose_name='未税预计')
    d_cost_sale_tax = models.FloatField(verbose_name='含税限价')
    d_cost_sale_untax = models.FloatField(verbose_name='未税限价')
    d_rate_tax = models.FloatField(verbose_name='含税比重')
    d_weight = models.FloatField(verbose_name='重量')
    t_last_purchase = models.CharField(max_length=32,verbose_name='最后采购时间')
    goods_id = models.IntegerField(verbose_name='商品ID')

class Erp_Purchase(models.Model):
    """ERP采购数据"""
    create_time = models.CharField(max_length=32,verbose_name='创建时间')
    t_get_estimate = models.CharField(max_length=32,verbose_name='预计到货时间')
    d_cq = models.CharField(max_length=8,verbose_name='超期天数')
    c_billcode = models.CharField(max_length=64,verbose_name='单号')
    c_sku = models.CharField(max_length=128, verbose_name='商品编码')
    c_name = models.CharField(max_length=256,verbose_name='客商')
    goodsName = models.CharField(max_length=512,verbose_name='商品名称')
    kd_n = models.IntegerField(verbose_name='开单数')
    d_price = models.FloatField(verbose_name='单价')
    goods_d_amount = models.FloatField(verbose_name='金额')
    n_get = models.IntegerField(verbose_name='已到数')
    goods_n_noget = models.IntegerField(verbose_name='未到数')
    goods_d_noget = models.FloatField(verbose_name='未到金额')
    goods_id = models.IntegerField(verbose_name='商品ID')
    c_handing_emp_org_name = models.CharField(max_length=32,verbose_name='业务员')

class KcErpSplr(models.Model):
    """ERP商品利润"""
    create_time = models.CharField(max_length=32,verbose_name='创建时间')
    customer_name = models.CharField(max_length=32,verbose_name='店铺	')
    c_sku = models.CharField(max_length=64,verbose_name='商品编码')
    c_series = models.CharField(max_length=64,verbose_name='系列	')
    c_brand = models.CharField(max_length=32,verbose_name='品牌	')
    c_category = models.CharField(max_length=128,verbose_name='类别	')
    c_goods_name = models.CharField(max_length=512,verbose_name='商品名称')
    c_ean13 = models.CharField(max_length=64,verbose_name='商品条码')
    sales_billcode = models.CharField(max_length=128,verbose_name='单号	')
    c_source_billcode = models.CharField(max_length=128,verbose_name='网店单号')
    n = models.IntegerField(verbose_name='数量	')
    d_price = models.FloatField(verbose_name='销售单价')
    d_amount = models.FloatField(verbose_name='销售金额')
    d_cost = models.FloatField(verbose_name='成本单价')
    d_amount_cost = models.FloatField(verbose_name='成本金额')
    d_discount = models.FloatField(verbose_name='商品折扣')
    d_fare_display = models.FloatField(verbose_name='运费成本')
    d_fee_platform_display = models.FloatField(verbose_name='平台费用')
    d_back = models.FloatField(verbose_name='返现费用')
    d_fee_charge = models.FloatField(verbose_name='其他费用')
    t_send = models.CharField(max_length=32,verbose_name='出库时间')
    t_pay_estimate = models.CharField(max_length=32,verbose_name='支付时间')
    c_vip_code = models.CharField(max_length=64,verbose_name='会员号')
    emp_name = models.CharField(max_length=32,verbose_name='职员')
    dept_name = models.CharField(max_length=32,verbose_name='部门')
